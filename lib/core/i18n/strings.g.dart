...
///
/// Built on 2025-08-13 at 02:19 UTC
...
class _StringsTextfieldEn {
	...
	// Translations
	late final _StringsTextfieldFullnameEn fullname = _StringsTextfieldFullnameEn._(_root);
	late final _StringsTextfieldEmailEn email = _StringsTextfieldEmailEn._(_root);
	late final _StringsTextfieldPasswordEn password = _StringsTextfieldPasswordEn._(_root);
	late final _StringsTextfieldPasswordConfirmEn password_confirm = _StringsTextfieldPasswordConfirmEn._(_root);
}
...
class _StringsId implements Translations {
	...
	@override late final _StringsTextfieldId textfield = _StringsTextfieldId._(_root);
	@override late final _StringsButtonId button = _StringsButtonId._(_root);
}
...
class _StringsLoginId implements _StringsLoginEn {
	...
	// Translations
	@override String get title => 'Welcome to Example';
	@override String get subtitle => 'Get your discount right away';
...
class _StringsRegisterId implements _StringsRegisterEn {
	...
	// Translations
	@override String get title => 'Create Your Account';
	@override String get subtitle => 'Get your discount right away';
	@override String get have_account => 'Already have an account?';
}
...
class _StringsTextfieldId implements _StringsTextfieldEn {
	...
	// Translations
	@override late final _StringsTextfieldFullnameId fullname = _StringsTextfieldFullnameId._(_root);
	@override late final _StringsTextfieldEmailId email = _StringsTextfieldEmailId._(_root);
	@override late final _StringsTextfieldPasswordId password = _StringsTextfieldPasswordId._(_root);
	@override late final _StringsTextfieldPasswordConfirmId password_confirm = _StringsTextfieldPasswordConfirmId._(_root);
}
...
class _StringsTextfieldFullnameId implements _StringsTextfieldFullnameEn {
	...
	// Translations
	@override String get label => 'Fullname';
	@override String get hint => 'Input your full name';
	@override String get error => 'Full name must not empty';
}
...
class _StringsTextfieldEmailId implements _StringsTextfieldEmailEn {
	...
	@override String get hint => 'Input your email';
	@override String get error => 'Email is not valid';
}
...
class _StringsTextfieldPasswordId implements _StringsTextfieldPasswordEn {
	...
	@override String get hint => 'Input your password';
	@override String get error => 'Password is not valid';
}

// Path: textfield.password_confirm
class _StringsTextfieldPasswordConfirmId implements _StringsTextfieldPasswordConfirmEn {
	_StringsTextfieldPasswordConfirmId._(this._root);

	@override final _StringsId _root; // ignore: unused_field

	// Translations
	@override String get label => 'Confirm Password';
	@override String get hint => 'Input your confirmation password';
	@override String get error => 'Confirmation password is not valid';
}
...
class _StringsRu implements Translations {
	...
	@override late final _StringsRegisterRu register = _StringsRegisterRu._(_root);
	@override late final _StringsTextfieldRu textfield = _StringsTextfieldRu._(_root);
	@override late final _StringsButtonRu button = _StringsButtonRu._(_root);
}
...
class _StringsTextfieldRu implements _StringsTextfieldEn {
	...
	// Translations
	@override late final _StringsTextfieldFullnameRu fullname = _StringsTextfieldFullnameRu._(_root);
	@override late final _StringsTextfieldEmailRu email = _StringsTextfieldEmailRu._(_root);
	@override late final _StringsTextfieldPasswordRu password = _StringsTextfieldPasswordRu._(_root);
	@override late final _StringsTextfieldPasswordConfirmRu password_confirm = _StringsTextfieldPasswordConfirmRu._(_root);
}
...
// Path: textfield.password_confirm
class _StringsTextfieldPasswordConfirmRu implements _StringsTextfieldPasswordConfirmEn {
...
extension on Translations {
	dynamic _flatMapFunction(String path) {
		switch (path) {
			case 'login.title': return 'Welcome to Example';
			case 'login.subtitle': return 'Get your discount right away';
			case 'login.no_account': return 'Don\'t have an account?';
			case 'register.title': return 'Create Your Account';
			case 'register.subtitle': return 'Get your discount right away';
			case 'register.have_account': return 'Already have an account?';
			case 'textfield.fullname.label': return 'Fullname';
			case 'textfield.fullname.hint': return 'Input your full name';
			case 'textfield.fullname.error': return 'Full name must not empty';
			case 'textfield.email.label': return 'Email';
			case 'textfield.email.hint': return 'Input your email';
			case 'textfield.email.error': return 'Email is not valid';
			case 'textfield.password.label': return 'Password';
			case 'textfield.password.hint': return 'Input your password';
			case 'textfield.password.error': return 'Password is not valid';
			case 'textfield.password_confirm.label': return 'Confirm Password';
			case 'textfield.password_confirm.hint': return 'Input your confirmation password';
			case 'textfield.password_confirm.error': return 'Confirmation password is not valid';
			case 'button.login': return 'Log In';
			case 'button.register': return 'Register';
			default: return null;
		}
	}
}
