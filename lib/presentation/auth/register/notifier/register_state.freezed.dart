...
abstract class $RegisterStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({List<CountryModel> countries, CountryModel? selectedCountry});
}
...
class _$RegisterStateImpl implements _RegisterState {
  const _$RegisterStateImpl(
      {final List<CountryModel> countries = const [], this.selectedCountry})
  ...
  @override
  String toString() {
    return 'RegisterState(countries: $countries, selectedCountry: $selectedCountry)';
  }
...
abstract class _RegisterState implements RegisterState {
  const factory _RegisterState(
      ...
      final CountryModel? selectedCountry}) = _$RegisterStateImpl;
